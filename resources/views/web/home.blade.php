...
<section id="inicio" class="hero">
    ...
    <div class="hero-container">
        <div class="hero-content">
            ...
            <p>Cosméticos de calidad premium para tu cuidado personal. Descubre nuestra línea completa de productos para el cabello y la piel.</p>
    ...
    <div class="promo-container">
        <div class="promo-content">
            ...
            <p class="promo-description">
                Llévate 2 productos y el tercero con <strong>30% de descuento</strong>.
                Válido para toda nuestra línea de shampoos y acondicionadores.
            </p>
