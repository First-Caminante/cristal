            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('web.productos', ['categoria' => 'shampoos']) }}">Shampoos</a></li>
                        <li><a href="{{ route('web.productos', ['categoria' => 'acondicionadores']) }}">Acondicionadores</a></li>
                        <li><a href="{{ route('web.productos', ['categoria' => 'cremas']) }}">Cremas Humectantes</a></li>
                        <li><a href="{{ route('web.productos', ['categoria' => 'tratamientos']) }}">Tratamientos Especiales</a></li>
                        <li><a href="{{ route('web.productos', ['categoria' => 'linea-natural']) }}">Línea Natural</a></li>
                        <li><a href="{{ route('web.productos', ['categoria' => 'linea-infantil']) }}">Línea Infantil</a></li>
                    </ul>
                </li>
        ...
        <div class="footer-content">
            ...
            <div class="footer-social">
                <div class="social-icons">
                    <a href="https://www.facebook.com/Cristalindustriasbo" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    ...
                    <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                             <path d="M16.5 3.5c.7 1.4 2 2.4 3.5 2.6v3.2c-1.7-.1-3.2-.7-4.5-1.7v7.3c0 3.7-3 6.6-6.7 6.6S2 18.6 2 14.9c0-3.7 3-6.6 6.7-6.6.5 0 1 .1 1.5.2v3.4c-.5-.3-.9-.4-1.5-.4-1.8 0-3.2 1.4-3.2 3.3s1.4 3.3 3.2 3.3 3.2-1.4 3.2-3.3V2h3.6c0 .5.1 1 .3 1.5l-.1 0z"/>
                        </svg>
                    </a>
