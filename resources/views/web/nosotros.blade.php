    ...
    <section class="historia-section">
        <div class="historia-container">
            ...
            <div class="historia-image">
                <img src="{{ asset('assets/images/nosotros/historia.png') }}" alt="Historia de Industrias Cristal">
    ...
    <section class="equipo-section">
        <div class="equipo-container">
            <div class="equipo-image">
                <img src="{{ asset('assets/images/nosotros/equipo.png') }}" alt="Nuestro Equipo">
            </div>
                    ...
                    <div class="feature-item">
                        <div class="feature-icon">
                            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                ...
                                <circle cx="8.5" cy="7" r="4" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M20 8V14M23 11H17" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </div>
        ...
        <div class="instalaciones-container">
            ...
            <div class="instalaciones-grid">
                <div class="instalacion-card">
                    <img src="{{ asset('assets/images/nosotros/planta.png') }}" alt="Planta de Producción">
                ...
                <div class="instalacion-card">
                    <img src="{{ asset('assets/images/nosotros/laboratorio.png') }}" alt="Laboratorio">
                    <div class="instalacion-content">
                ...
                <div class="instalacion-card">
                    <img src="{{ asset('assets/images/nosotros/control.png') }}" alt="Control de Calidad">
                    <div class="instalacion-content">
                        <h4>Control de Calidad</h4>
